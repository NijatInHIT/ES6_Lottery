...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _caculator = __webpack_require__(332);

	var _caculator2 = _interopRequireDefault(_caculator);
	...
	var copyInDeep = function copyInDeep(target, source) {
	...
	var Lottery = function (_mix) {
	    ...
	    function Lottery() {
	        ...
	        var issure = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : "*";
	    ...
	    _createClass(Lottery, [{
	        ...
	        value: function updateState() {
	            var self = this;
	            this.getState().then(function (rec) {
	                self.issure = rec.issure;
	                self.end_time = rec.end_time;
	                self.state = rec.state;
	                (0, _jquery2.default)(self.issure_el).text(rec.issure);
	                self.countdown(res.end_time, function (time) {
	                    (0, _jquery2.default)(self.countdown_el).html(time);
	                }, function () {
	                    setTimeout(function () {
	                        self.updateState();
	                        self.getOmit(self.issure).then(function (rec) {});
	                        self.getOpenCode(self.issure).then(function (rec) {});
	                    }, 500);
	                });
	            });
	        }
	    ...
	    return Lottery;
	}(mix(_base2.default, _caculator2.default, _timer2.default, _interface2.default));
	    ...
	    _createClass(Base, [{
	        ...
	        value: function setOmit(omit) {
	            ...
	            (0, _jquery2.default)(self.omit_el).each(function (index, item) {
	                (0, _jquery2.default)(itm).text(self.omit.get(index));
	            });
	        }
	    }, {
	        key: 'setOpenCode',
	...
	var Caculator = function () {
	    ...
	    _createClass(Caculator, [{
	        ...
	        value: function computeCount(active, play_name) {
	            var count = 0;
	            var exist = this.play_list.has(play_name); //map
	            var arr = new Array(active).fill('0'); // array
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Interface = function () {
	    ...
	    _createClass(Interface, [{
	        ...
	        value: function getOmit(issure) {
	            ...
	            return new Promise(function (resolve, reject) {
	                _jQuery2.default.ajax({
	                    ...
	                    dataType: 'json',
	                    success: function success(rec) {
	                        console.log('http success');
	                        self.setOmit(rec.data);
	                        resolve.call(self, rec);
	                    },
	                    error: function error(rec) {
	        ...
	        key: 'getOpenCode',
	        value: function getOpenCode(issure) {
	            var self = this;
	            return new Promise(function (resolve, reject) {
	                _jQuery2.default.ajax({
	                    url: 'ddd',
	        ...
	        key: 'getState',
	        value: function getState(issure) {
	            var self = this;
	            return new Promise(function (resolve, reject) {
	                _jQuery2.default.ajax({
	                    url: 'ddd',
